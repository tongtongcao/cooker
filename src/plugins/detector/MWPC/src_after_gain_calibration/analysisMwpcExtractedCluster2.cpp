...
Long_t Det_MWPC::histos_analysisExtractedCluster2(){
  ...
  for(int i=0;i<12;i++){
    sstr_name<<"Adc Vs Strip for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for No Cut";
    ...
    sstr_name<<"Adc Vs Strip for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for Threshold and Total-Charge Cuts";
    sstr_title<<sstr_name.str()<<";Strip Number; ADC Value";
    ...
    sstr_name<<"Adc Vs Strip for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for Threshold, Total-Charge and First-Flag Cuts";
    sstr_title<<sstr_name.str()<<";Strip Number; ADC Value";
    ...
    sstr_name<<"Position for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for No Cut";
    ...
    sstr_name<<"Position for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for Threshold and Total-Charge Cuts";
    sstr_title<<sstr_name.str()<<";Position; Counts";
    histPosThTCCut[i]=new TH1D(sstr_name.str().c_str(),sstr_title.str().c_str(),((i%4)/2*(-5)+(i/4)*(!((i%4)/2))+7)*8,0,((i%4)/2*(-5)+(i/4)*(!((i%4)/2))+7)*8);
    sstr_name.str("");
    sstr_title.str("");

    sstr_name<<"Position for all pairs of "<<"MwpcC"<<i/4+2<<(char)((i%4)/2+88)<<(char)((i%4%2)*6+76)<<" for Threshold, Total-Charge and First-Flag Cuts";
    sstr_title<<sstr_name.str()<<";Position; Counts";
...
Long_t Det_MWPC::process_analysisExtractedCluster2(){
  for(int i=0;i<12;i++){
    for(UInt_t j=0;j<treeCali->noCutPairClusterStNum[i].size();j++){
      histPosNoCut[i]->Fill(treeCali->noCutClusterPosCentroid[i][j]);
      for(UInt_t k=0;k<treeCali->noCutPairClusterStNum[i][j].size();k++){
        histAdcVsStNoCut[i]->Fill(treeCali->noCutPairClusterStNum[i][j][k],treeCali->noCutPairClusterStCharge[i][j][k]);
      }
    }
    for(UInt_t j=0;j<treeCali->thTCCutPairClusterStNum[i].size();j++){
      histPosThTCCut[i]->Fill(treeCali->thTCCutClusterPosCentroid[i][j]);
      for(UInt_t k=0;k<treeCali->thTCCutPairClusterStNum[i][j].size();k++){
        histAdcVsStThTCCut[i]->Fill(treeCali->thTCCutPairClusterStNum[i][j][k],treeCali->thTCCutPairClusterStCharge[i][j][k]);
      }
    }
    if(treeCali->thTCCutLeftFlagFirst==1 || treeCali->thTCCutRightFlagFirst==1){
      for(UInt_t j=0;j<treeCali->thTCCutPairClusterStNum[i].size();j++){
        ...
        for(UInt_t k=0;k<treeCali->thTCCutPairClusterStNum[i][j].size();k++){
          histAdcVsStThTCFFCut[i]->Fill(treeCali->thTCCutPairClusterStNum[i][j][k],treeCali->thTCCutPairClusterStCharge[i][j][k]);
        }
      }
    }
...
Long_t Det_MWPC::done_analysisExtractedCluster2(){
  TCanvas *canvAdcVsStNoCut=new TCanvas("Adc Vs Strip for all pairs for No Cut","Adc Vs Strip for all pairs for No Cut",2000,1500);
  ...
  canvAdcVsStNoCut->SaveAs("Adc Vs Strip for all pairs for No Cut.pdf");


  TCanvas *canvAdcVsStThTCCut=new TCanvas("Adc Vs Strip for all pairs for Threshold and Total-Charge Cuts","Adc Vs Strip for all pairs for Threshold and Total-Charge Cuts",2000,1500);
  ...
  canvAdcVsStThTCCut->SaveAs("Adc Vs Strip for all pairs for Threshold and Total-Charge Cuts.pdf");

  TCanvas *canvAdcVsStThTCFFCut=new TCanvas("Adc Vs Strip for all pairs for Threshold, Total-Charge and First-Flag Cuts","Adc Vs Strip for all pairs for Threshold, Total-Charge and First-Flag Cuts",2000,1500);
  ...
  canvAdcVsStThTCFFCut->SaveAs("Adc Vs Strip for all pairs for Threshold, Total-Charge and First-Flag Cuts.pdf");
  ...
  TCanvas *canvPosNoCut=new TCanvas("Position for all pairs for No Cut","Position for all pairs for No Cut",2000,900);
  ...
  canvPosNoCut->SaveAs("Position for all pairs for No Cut.pdf");

  TCanvas *canvPosThTCCut=new TCanvas("Position for all pairs for Threshold and Total-Charge Cuts","Position for all pairs for Threshold and Total-Charge Cuts",2000,900);
  ...
  canvPosThTCCut->SaveAs("Position for all pairs for Threshold and Total-Charge Cuts.pdf");

  TCanvas *canvPosThTCFFCut=new TCanvas("Position for all pairs for Threshold, Total-Charge and First-Flag Cuts","Position for all pairs for Threshold, Total-Charge and First-Flag Cuts",2000,900);
  ...
  canvPosThTCFFCut->SaveAs("Position for all pairs for Threshold, Total-Charge and First-Flag Cuts.pdf");
