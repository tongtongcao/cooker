...
//  string inputFilePath(getenv("tracking_inputFiles"));
// string inputFile=inputFilePath+"/B-map-I1150.txt";
 string inputFile="/data/trek/E36/gautam/crnRoot/cooker/inputFiles/tracking/B-map-I1150_new.txt";
//string inputFile="/data/trek/E36/gautam/crnRoot/cooker/inputFiles/tracking/B-map-I650_new.txt";
