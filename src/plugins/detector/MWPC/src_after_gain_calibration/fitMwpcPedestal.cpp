...
static TH1D* h1SigmaC2XL;
static TH1D* h1SigmaC2XR;
static TH1D* h1SigmaC2YL;
static TH1D* h1SigmaC2YR;
static TH1D* h1SigmaC3XL;
static TH1D* h1SigmaC3XR;
static TH1D* h1SigmaC3YL;
static TH1D* h1SigmaC3YR;
static TH1D* h1SigmaC4XL;
static TH1D* h1SigmaC4XR;
static TH1D* h1SigmaC4YL;
static TH1D* h1SigmaC4YR;
...
Long_t Det_MWPC::histos_ped()
{
  ...
  h1SigmaC2XL=new TH1D("SigmaC2XL","Sigma for MWPCC2XL;Strip;Sigma",56,-0.5,55.5);
  h1SigmaC2XR=new TH1D("SigmaC2XR","Sigma for MWPCC2XR;Strip;Sigma",56,-0.5,55.5);
  h1SigmaC2YL=new TH1D("SigmaC2YL","Sigma for MWPCC2YL;Strip;Sigma",16,-0.5,15.5);
  h1SigmaC2YR=new TH1D("SigmaC2YR","Sigma for MWPCC2YR;Strip;Sigma",16,-0.5,15.5);
  h1SigmaC3XL=new TH1D("SigmaC3XL","Sigma for MWPCC3XL;Strip;Sigma",64,-0.5,63.5);
  h1SigmaC3XR=new TH1D("SigmaC3XR","Sigma for MWPCC3XR;Strip;Sigma",64,-0.5,63.5);
  h1SigmaC3YL=new TH1D("SigmaC3YL","Sigma for MWPCC3YL;Strip;Sigma",16,-0.5,15.5);
  h1SigmaC3YR=new TH1D("SigmaC3YR","Sigma for MWPCC3YR;Strip;Sigma",16,-0.5,15.5);
  h1SigmaC4XL=new TH1D("SigmaC4XL","Sigma for MWPCC4XL;Strip;Sigma",72,-0.5,71.5);
  h1SigmaC4XR=new TH1D("SigmaC4XR","Sigma for MWPCC4XR;Strip;Sigma",72,-0.5,71.5);
  h1SigmaC4YL=new TH1D("SigmaC4YL","Sigma for MWPCC4YL;Strip;Sigma",16,-0.5,15.5);
  h1SigmaC4YR=new TH1D("SigmaC4YR","Sigma for MWPCC4YR;Strip;Sigma",16,-0.5,15.5);
...
Long_t Det_MWPC::process_ped()
{
  ...
  for(int iChx2=0;iChx2<56;iChx2++){
    if(treeRaw->ADC_C2X_L[C2XStTrans[iChx2]]>0)
      pedC2XL[iChx2]->addData(treeRaw->ADC_C2X_L[C2XStTrans[iChx2]]); // Strip transformation
    if(treeRaw->ADC_C2X_R[C2XStTrans[iChx2]]>0)
      pedC2XR[iChx2]->addData(treeRaw->ADC_C2X_R[C2XStTrans[iChx2]]); // Strip transformation
  }
  for(int iChx3=0;iChx3<64;iChx3++){
...
Long_t Det_MWPC::done_ped(){
  ...
  for(int iChy=0;iChy<16;iChy++){
    ...
    h1PedestalC2YL->SetBinError(1+iChy,errC2YL[iChy]);
    h1SigmaC2YL->SetBinContent(1+iChy,sigmaC2YL[iChy]);
    h1SigmaC2YL->SetBinError(1+iChy,sigmaErrC2YL[iChy]);
    ...
    h1PedestalC3YL->SetBinError(1+iChy,errC3YL[iChy]);
    h1SigmaC3YL->SetBinContent(1+iChy,sigmaC3YL[iChy]);
    h1SigmaC3YL->SetBinError(1+iChy,sigmaErrC3YL[iChy]);
    ...
    h1PedestalC4YL->SetBinError(1+iChy,errC4YL[iChy]);
    h1SigmaC4YL->SetBinContent(1+iChy,sigmaC4YL[iChy]);
    h1SigmaC4YL->SetBinError(1+iChy,sigmaErrC4YL[iChy]);
    ...
    h1PedestalC2YR->SetBinError(1+iChy,errC2YR[iChy]);
    h1SigmaC2YR->SetBinContent(1+iChy,sigmaC2YR[iChy]);
    h1SigmaC2YR->SetBinError(1+iChy,sigmaErrC2YR[iChy]);
    ...
    h1PedestalC3YR->SetBinError(1+iChy,errC3YR[iChy]);
    h1SigmaC3YR->SetBinContent(1+iChy,sigmaC3YR[iChy]);
    h1SigmaC3YR->SetBinError(1+iChy,sigmaErrC3YR[iChy]);
    ...
    h1PedestalC4YR->SetBinError(1+iChy,errC4YR[iChy]);
    h1SigmaC4YR->SetBinContent(1+iChy,sigmaC4YR[iChy]);
    h1SigmaC4YR->SetBinError(1+iChy,sigmaErrC4YR[iChy]);
  ...
  for(int iChx2=0;iChx2<56;iChx2++){
    ...
    h1PedestalC2XL->SetBinError(1+iChx2,errC2XL[iChx2]);
    h1SigmaC2XL->SetBinContent(1+iChx2,sigmaC2XL[iChx2]);
    h1SigmaC2XL->SetBinError(1+iChx2,sigmaErrC2XL[iChx2]);
    ...
    h1PedestalC2XR->SetBinError(1+iChx2,errC2XR[iChx2]);
    h1SigmaC2XR->SetBinContent(1+iChx2,sigmaC2XR[iChx2]);
    h1SigmaC2XR->SetBinError(1+iChx2,sigmaErrC2XR[iChx2]);
  ...
  for(int iChx3=0;iChx3<64;iChx3++){
    ...
    h1PedestalC3XL->SetBinError(1+iChx3,errC3XL[iChx3]);
    h1SigmaC3XL->SetBinContent(1+iChx3,sigmaC3XL[iChx3]);
    h1SigmaC3XL->SetBinError(1+iChx3,sigmaErrC3XL[iChx3]);
    ...
    h1PedestalC3XR->SetBinError(1+iChx3,errC3XR[iChx3]);
    h1SigmaC3XR->SetBinContent(1+iChx3,sigmaC3XR[iChx3]);
    h1SigmaC3XR->SetBinError(1+iChx3,sigmaErrC3XR[iChx3]);
  ...
  for(int iChx4=0;iChx4<72;iChx4++){
    ...
    h1PedestalC4XL->SetBinError(1+iChx4,errC4XL[iChx4]);
    h1SigmaC4XL->SetBinContent(1+iChx4,sigmaC4XL[iChx4]);
    h1SigmaC4XL->SetBinError(1+iChx4,sigmaErrC4XL[iChx4]);
    ...
    h1PedestalC4XR->SetBinError(1+iChx4,errC4XR[iChx4]);
    h1SigmaC4XR->SetBinContent(1+iChx4,sigmaC4XR[iChx4]);
    h1SigmaC4XR->SetBinError(1+iChx4,sigmaErrC4XR[iChx4]);
  ...
  TCanvas *canvPedestal=new TCanvas("mwpcPedestalVsSt","mwpcPedestalvsSt",1200,900);
  canvPedestal->Divide(4,3);
  canvPedestal->cd(1);
  ...
  h1PedestalC4YR->Draw();
  canvPedestal->SaveAs("mwpcPedestalVsSt.pdf");

  TCanvas *canvSigma=new TCanvas("mwpcSigmaVsSt","mwpcSigmavsSt",1200,900);
  canvSigma->Divide(4,3);
  canvSigma->cd(1);
  h1SigmaC2XL->SetMinimum(0);
  h1SigmaC2XL->SetMaximum(80);
  h1SigmaC2XL->Draw();
  canvSigma->cd(2);
  h1SigmaC2XR->SetMinimum(0);
  h1SigmaC2XR->SetMaximum(80);
  h1SigmaC2XR->Draw();
  canvSigma->cd(3);
  h1SigmaC2YL->SetMinimum(0);
  h1SigmaC2YL->SetMaximum(80);
  h1SigmaC2YL->Draw();
  canvSigma->cd(4);
  h1SigmaC2YR->SetMinimum(0);
  h1SigmaC2YR->SetMaximum(80);
  h1SigmaC2YR->Draw();
  canvSigma->cd(5);
  h1SigmaC3XL->SetMinimum(0);
  h1SigmaC3XL->SetMaximum(80);
  h1SigmaC3XL->Draw();
  canvSigma->cd(6);
  h1SigmaC3XR->SetMinimum(0);
  h1SigmaC3XR->SetMaximum(80);
  h1SigmaC3XR->Draw();
  canvSigma->cd(7);
  h1SigmaC3YL->SetMinimum(0);
  h1SigmaC3YL->SetMaximum(80);
  h1SigmaC3YL->Draw();
  canvSigma->cd(8);
  h1SigmaC3YR->SetMinimum(0);
  h1SigmaC3YR->SetMaximum(80);
  h1SigmaC3YR->Draw();
  canvSigma->cd(9);
  h1SigmaC4XL->SetMinimum(0);
  h1SigmaC4XL->SetMaximum(80);
  h1SigmaC4XL->Draw();
  canvSigma->cd(10);
  h1SigmaC4XR->SetMinimum(0);
  h1SigmaC4XR->SetMaximum(80);
  h1SigmaC4XR->Draw();
  canvSigma->cd(11);
  h1SigmaC4YL->SetMinimum(0);
  h1SigmaC4YL->SetMaximum(80);
  h1SigmaC4YL->Draw();
  canvSigma->cd(12);
  h1SigmaC4YR->SetMinimum(0);
  h1SigmaC4YR->SetMaximum(80);
  h1SigmaC4YR->Draw();
  canvSigma->SaveAs("mwpcSigmaVsSt.pdf");

  ofstream output("pedestal.h");

  output<<"const double pedValueC2YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC2YL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC2YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC2YL[i]<<", ";
    else
  ...
  output<<"const double pedValueC2YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC2YR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC2YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC2YR[i]<<", ";
    else
  ...
  output<<"const double pedValueC3YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC3YL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC3YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC3YL[i]<<", ";
    else
  ...
  output<<"const double pedValueC3YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC3YR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC3YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC3YR[i]<<", ";
    else
  ...
  output<<"const double pedValueC4YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC4YL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC4YL[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC4YL[i]<<", ";
    else
  ...
  output<<"const double pedValueC4YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<pddC4YR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC4YR[16]={";
  for(int i=0;i<16;i++){
    if(i<15)
      output<<sigmaC4YR[i]<<", ";
    else
  ...
  output<<"const double pedValueC2XL[56]={";
  for(int i=0;i<56;i++){
    if(i<55)
      output<<pddC2XL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC2XL[56]={";
  for(int i=0;i<56;i++){
    if(i<55)
      output<<sigmaC2XL[i]<<", ";
    else
  ...
  output<<"const double pedValueC2XR[56]={";
  for(int i=0;i<56;i++){
    if(i<55)
      output<<pddC2XR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC2XR[56]={";
  for(int i=0;i<56;i++){
    if(i<55)
      output<<sigmaC2XR[i]<<", ";
    else
  ...
  output<<"const double pedValueC3XL[64]={";
  for(int i=0;i<64;i++){
    if(i<63)
      output<<pddC3XL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC3XL[64]={";
  for(int i=0;i<64;i++){
    if(i<63)
      output<<sigmaC3XL[i]<<", ";
    else
  ...
  output<<"const double pedValueC3XR[64]={";
  for(int i=0;i<64;i++){
    if(i<63)
      output<<pddC3XR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC3XR[64]={";
  for(int i=0;i<64;i++){
    if(i<63)
      output<<sigmaC3XR[i]<<", ";
    else
  ...
  output<<"const double pedValueC4XL[72]={";
  for(int i=0;i<72;i++){
    if(i<71)
      output<<pddC4XL[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC4XL[72]={";
  for(int i=0;i<72;i++){
    if(i<71)
    output<<sigmaC4XL[i]<<", ";
  else
  ...
  output<<"const double pedValueC4XR[72]={";
  for(int i=0;i<72;i++){
    if(i<71)
      output<<pddC4XR[i]<<", ";
    else
  ...
  output<<"const double pedSigmaC4XR[72]={";
  for(int i=0;i<72;i++){
    if(i<71)
      output<<sigmaC4XR[i]<<", ";
    else
