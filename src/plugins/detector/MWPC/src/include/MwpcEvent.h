...
class MwpcEvent{
 ...
 void addHistData(int* value); // Set bin content of histogram without pedestal subtraction and threshold cut
 void addHistData_pedSub(int* value, const double* pdd); // Set bin content of histogram with pedestal subtraction
 void addHistData_pedSub_sigmaCut(int* value, const double* pdd, const double* sigma, double nSigma); // Set bin content of histogram with pedestal subtraction and global threshold cut; Need to specify factor of sigma to determine threshold
 ...
 int getEachClusterStNumWithHighestADC(vector<int> stNum,vector<double> stCharge);
 double getEachClusterPositionCentroidUpto3St(vector<int> stNum,vector<double> stCharge);
 double getEachClusterPositionErrorCentroidUpto3St(vector<double> stCharge);

 double getEachClusterPositionChargeRatio(vector<int> stNum,vector<double> stCharge);
