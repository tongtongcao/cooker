...
int Ep_uc = 12;
int Ep_c = 6;
 final_PgCAdc =  new TH1F( "final_PgCAdc","final_PgCAdc",100,10,adc_uc);
  ...
  for(int i = 0; i < 12; i++){
    ...
    h1adc_PgC[i] = dH1(name1.c_str(),title1.c_str(),40,10,adc_uc);
    ...
    for(int ii=0;ii<7;ii++){
      ...
      ADC_PgCh[i][ii]= dH1(namep.c_str(),titlep.c_str(),12,0,adc_uc);
