...
trackSystem::trackSystem(Int_t n) : TObjArray(n), fNMissingHits(0),  fNHits(-1), fChi2(0.), fNDF(0), fCurSitePtr(0), fIsGood(kTRUE), fGapNumTof2(0){}
//_____________________________________________________________________
...
Int_t trackSystem::Compare( const TObject* obj ) const{
  ...
  // assert( dynamic_cast<const trackSystem*>(obj) );
   dynamic_cast<const trackSystem*>(obj);
